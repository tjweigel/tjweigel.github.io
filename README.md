# Hello
Welcome to [my website](http://tjweigel.com). For this version, I have continued to take a minimal approach. I only show relevant and what I believe to be my most important information. The site was built using [Foundation5](http://foundation.zurb.com/docs/) and a `12-column-grid`, as a result, it's always improving. My main goal for this project is to continue to improve my CSS. Not only improve the speed at which I write it but the speed of my website as well.
